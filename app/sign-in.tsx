...
export default function SignIn() {
  ...
  const { expoPushToken } = usePushNotifications(); // Get push token
  ...
  return (
    <View className="flex-1 justify-center items-center p-4 bg-white">
      ...
      <Pressable onPress={handleSignInPress} className="bg-blue-600 w-full max-w-[300px] py-3 rounded-lg active:bg-blue-700">
