...
//           />
//           <Button title="Upload Photo (Optional)" onPress={handleFileChange} />
//           {/* {formData.photo && <Image source={{ uri: formData.photo }} style={styles.image} />} */}
...
// function launchImageLibrary(options: { mediaType: string; quality: number; }, arg1: (response: any) => void) {
